...
public class UserQuestionCommand implements UserInterface {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	  ...
	  if(lately == 0) vos = dao.getQuestionList(startIndexNo, pageSize); // 전체자료
	  else vos = dao.getQuestionLately(startIndexNo, pageSize, lately); // 지정된자료
