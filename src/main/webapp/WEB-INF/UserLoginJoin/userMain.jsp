...
<jsp:include page="/include/menuHeader.jsp"/>
	<div style="width: 100%;">
		<div class="w3-container w3-white w3-xlarge" style="width: 100%;">
			...
			<br/><br/><br/><br/>
			<div align=center>
				<video width="90%"src="${ctp}/images/메인영상1.mp4" autoplay loop control circle style="display: block;" muted></video>
			</div>
			<br/><br/><br/><br/>
			...
			<br/><br/><br/><br/>
			<div align=center>
				<video width="90%"src="${ctp}/images/메인영상2.mp4" autoplay loop control circle style="display: block;" muted></video>
			</div>
			<br/><br/><br/><br/>
