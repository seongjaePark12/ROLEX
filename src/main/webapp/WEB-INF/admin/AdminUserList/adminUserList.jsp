			...
			<table class="table table-borderless m-0">
				...
				<tr>
					<td style="text-align: left">
						<input class="w3-panel w3-border w3-round-large" type="text" name="mid" value="${mid}" placeholder="검색할아이디입력"/>
						<input class="btn btn-warning btn-sm w3-round-xxlarge" type="button" value="개별검색" onclick="midSearch()"/>
						<input type="button" value="전체보기" onclick="location.href='${ctp}/adminUserList.boss';" class="btn btn-warning btn-sm w3-round-xxlarge"/>
					</td>
					<td style="text-align: right">
						회원등급
						<select name="level" onchange="levelSearch()" class="w3-panel w3-border w3-round-xxlarge">
