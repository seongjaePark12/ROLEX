	...
	<p><br/></p>
	  <div class="container">
	    <h2 style="text-align:center; color: #626262;">
	      <a href="${ctp}/userNotice.boss" style="text-decoration: none;">NOTICE</a>
	    </h2>
	    <br>
	      ...
	      <tbody>
		      ...
		      <tr class="text-center">
		        <td class="con2" colspan="2">
		          <br>
		            <input class="btn btn-outline-warning" type="button" value="돌아가기" onclick="location.href='${ctp}/userNotice.psj?pag=${pag}&pageSize=${pageSize}&lately=${lately}';"/>
		        		<c:if test="${sLevel == 0}">
			  	...
			  	<tr style="border-bottom: 1px solid #E2E2E2;">
			  		...
			  		<td class="con2" align="left" style="padding-left: 30px;">
			  			<c:if test="${nextVO.nextIdx != 0}">
							<a href="${ctp}/userNoticeContent.psj?idx=${nextVO.nextIdx}&pag=${pag}&pageSize=${pageSize}&lately=${lately}">${nextVO.nextTitle}</a><br/>
							</c:if>
			  		</td>
			  	</tr>
			  	<tr>
			  		...
			  		<td class="con2" align="left" style="padding-left: 30px;">
			  			<c:if test="${preVO.preIdx != 0}">
							<a href="${ctp}/userNoticeContent.psj?idx=${preVO.preIdx}&pag=${pag}&pageSize=${pageSize}&lately=${lately}">${preVO.preTitle}</a><br/>
							</c:if>
			  		</td>
			  	</tr>
	  		</tbody>
