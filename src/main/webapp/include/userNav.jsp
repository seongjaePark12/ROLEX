...
<div class="w3-bar w3-black w3-padding-24 w3-large">
  ...
  <a href="${ctp}/userUpdateMove.psj" class="w3-bar-item w3-button">정보수정</a>
  <a href="${ctp}/bookingUser.boo" class="w3-bar-item w3-button w3-hide-small">예약내역</a>
...
<div id="demo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-padding-24">
  ...
  <a href="${ctp}/userUpdateMove.psj" class="w3-bar-item w3-button">정보수정</a>
  <a href="${ctp}/bookingUser.boo" class="w3-bar-item w3-button">예약내역</a>
