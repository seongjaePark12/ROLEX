...
<script>
		function delCheck(){
  		...
  		if(ans) location.href="${ctp}/userQuestionDelete.psj?idx=${vo.idx}&pag=${pag}&pageSize=${pageSize}&lately=${lately}";
  	}
  	...
  	function replyCheck(){
  		...
  		$.ajax({
  			type : "post",
  			url : "${ctp}/userQuestionReplyInput.psj",
  			data : query,
  			success:function(){
  				location.reload();
  			}
  	...
  	function replyUpdateCheck(replyIdx){
  		...
  		$.ajax({
  			type : "post",
  			url : "${ctp}/userQuestionReplyUpdateOk.psj",
  			data : query,
  			success:function(){
  				location.reload();
  			}
  	...
  	function replyDelCheck(replyIdx){
  		...
  		$.ajax({
  			type : "post",
  			url : "${ctp}/userQuestionReplyDelete.psj",
  			data : query,
  			success:function(){
  				location.reload();
  			}
